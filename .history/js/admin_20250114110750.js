    ...
    async handleAddCode() {
        ...
        try {
            ...
            const accessCodeData = {
                ...
                createdBy,
                createdOn: new Date(),
                // These will be set automatically by the schema defaults:
                // user: name (backward compatibility)
                // unit: derived from type
                // isAdmin: derived from type
            };
                    ...
                    <div class="code-item" data-code="${code.code}" role="listitem">
                        <div class="code-details">
                            ...
                            <div class="code-info" role="list">
                                <div role="listitem">Name: <span class="info-value">${code.user}</span></div>
